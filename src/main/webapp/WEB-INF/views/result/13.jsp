		...
		<div id="wrap">
			...
			<div>
				<ul id="list">
					<li>
						<section>
							<a href="https://youtu.be/tvciu9_jHjQ" target="_blank">
								<img src="../images/newlec.png" class="imglogo" alt="로고사진">
							</a>
							<article>
								<h4>뉴렉처 - 자바 프로그래밍</h4>
								<p>이 강의는 Java 프로그래밍을 "제대로 공부해 보려는 사람들"을 위해 마련된 강의입니다.<br><br>
								강의내용 : 자바 언어의 특징, 값의 종류와 표현방법, 변수 선언, 콘솔 출력, 연산자, 제어 구조, 배열 등</p>
								<a href="https://youtu.be/tvciu9_jHjQ" target="_blank">more ></a>
							</article>
						</section>
					</li>
					<li>
